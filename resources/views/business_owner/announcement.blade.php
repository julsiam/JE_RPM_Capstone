                    ...
                    <div class="card-header d-flex justify-content-between align-items" style="height: 55px;">
                        ...
                        <div class="input-group" style="width:30%">
                            ...
                            <button class="btn btn-outline-dark btn-sm" type="button"
                                style="height: 35px; background-color:#FFA500;"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal"
                            data-bs-target="#addAnnouncementModal" style="background: #FFA500;"><svg
                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex">
                                ...
                                <button type="button" class="btn btn-outline-danger deleteBtn"
                                    value="{{ $announcement->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <button type="button" class="btn btn-outline-dark announcement_edit_btn"
                                    ...
                                    data-bs-target="#editAnnouncementModal" style="background-color: #FFA500;">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <img style="width: 42px"
                                            src="{{ Storage::disk('s3')->url(Auth::user()->profile_picture) }}" alt=""
                ...
                <form method="POST" action="{{ route('announcement.addAnnouncement') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="details" class="form-control @error('details') is-invalid @enderror"
                            name="details" rows="4" required>{{ old('details') }}</textarea>
                        @error('details')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-outline-dark"
                            style="background-color:  #FFA500;">{{ __('Submit') }}</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body" style="background-color: #F2F2F3;">
                <form method="POST" action="{{ route('editAnnouncement') }}">
                    ...
                    <div class="mb-3">
                        <div class="p-2">
                            <input id="edit_announcement_id" required style="border-color: rgb(166, 166, 166)"
                                type="hidden" class="form-control" name="edit_announcement_id" value="" readonly>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="edit_details" class="form-control @error('edit_details') is-invalid @enderror"
                            name="edit_details" rows="4" required>{{ old('edit_details') }}</textarea>
                        @error('edit_details')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
