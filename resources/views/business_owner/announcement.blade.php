                ...
                <div class="card" style="border-width:2px; border-color:#A9A9A9;">
                    ...
                    <div class="card-header d-flex justify-content-between align-items" style="height: 55px;">
                        ...
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#addAnnouncementModal" style="background: #FFA500; color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-megaphone"
                                viewBox="0 0 16 16">
                                <path
