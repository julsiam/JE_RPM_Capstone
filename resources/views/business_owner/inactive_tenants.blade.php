    ...
    <div class="card mt-2" style="border-radius: 25px;">
        <div class="row justify-content-center"
            ...
            <div class="col-md-6 text-end p-2">
                {{-- INACTIVE --}}
                <a href="{{ route('tenants') }}" class="btn btn btn-outline-warning me-2" style="color:#135083;">Active
                    Tenants
            ...
            {{-- <div class="modal fade" id="inactiveTenantProfileModal" tabindex="-1" aria-labelledby="tenantProfileModal"
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    ...
                    <div class="modal-body m-2">
                        <div class="mb-3">
                            <div class="">
                                <input id="inactive_tenant_id" required style="border-color: rgb(166, 166, 166)" type=""
                                    class="form-control" name="inactive_tenant_id" value="" readonly>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input id="inactive_last_name" style="border-color: rgb(166, 166, 166)"
                                                type="text" class="form-control" name="inactive_last_name" readonly
                                                value="">
                                        </div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input id="inactive_email" style="border-color: rgb(166, 166, 166)"
                                                type="text" class="form-control" name="inactive_email" value=""
                                                readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input id="inactive_phone_number" style="border-color: rgb(166, 166, 166)"
                                                type="text" class="form-control" name="inactive_phone_number" readonly
                                                value="">
                                        </div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input id="inactive_birthdate" style="border-color: rgb(166, 166, 166)"
                                                type="text" class="form-control" name="inactive_birthdate" readonly
                                                value="">
                                        </div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input id="inactive_age" style="border-color: rgb(166, 166, 166)"
                                                type="text" class="form-control" name="inactive_age" readonly value="">
                                        </div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input id="inactive_occupation" style="border-color: rgb(166, 166, 166)"
                                                type="text" class="form-control" name="inactive_occupation" readonly
                                                value="">
                                        </div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input id="inactive_work_address" style="border-color: rgb(166, 166, 166)"
                                                type="text" class="form-control" name="inactive_work_address" readonly
                                                value="">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row align-items-start">
                                            <div class="form-group col md-5">
                                                ...
                                                <input id="inactive_location" style="border-color: rgb(166, 166, 166)"
                                                    type="text" class="form-control" name="inactive_location" readonly
                                                    value="">
                                            </div>
                                            <div class="form-group col md-5">
                                                <label style="color: rgb(128, 128, 128)">Room Unit</label>
                                                <input id="inactive_room_unit" style="border-color: rgb(166, 166, 166)"
                                                    type="text" class="form-control" name="inactive_room_unit" readonly
                                                    value="">
                                            </div>
                                            <div class="form-group col md-5">
                                                ...
                                                <input id="inactive_movein_date"
                                                    style="border-color: rgb(166, 166, 166)" type="text"
                                                    class="form-control" name="inactive_movein_date" readonly value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
