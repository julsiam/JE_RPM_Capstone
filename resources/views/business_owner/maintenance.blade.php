            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('tenant.editMaintenanceStatus') }}" method="POST">
                            @csrf
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <div class="input-group">
                                                <input id="modal_maintenance_status" required
                                                    ...
                                                    class="form-control" name="modal_maintenance_status" value="">
                                                {{-- <select id="modal_maintenance_status" name="modal_maintenance_status" class="form-select form-select-sm">
