                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm btn-details" data-bs-toggle="modal"
                                            data-bs-target="#maintenanceModal">Details</button>
                                        {{-- <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#maintenanceModal{{ $maintenance->id }}">Details</button> --}}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="#" method="#">
                            ...
                            <div class="p-2">
                                <h6 class="card-title">MAINTENANCE REQUEST BY : JULS ESTORCO</h6>
                            </div>
                            ...
                            <div class="card p-4">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span id="location" style="border-color: rgb(166, 166, 166); font-size:18px"
                                                class="form-control-static">Danao City, Cebu</span>
                                        </div>

                                        <div class="form-group mt-2">
                                            <label style="color: rgb(128, 128, 128); font-size:18px">Room Unit:</label>
                                            <span id="room_unit" style="border-color: rgb(166, 166, 166); font-size:18px"
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <div class="input-group">
                                                <select id="maintenance_status" class="form-select form-select-sm">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span id="author" style="border-color: rgb(166, 166, 166); font-size:18px"
                                                class="form-control-static">Juls Estorco</span>
                                        </div>
                                        <div class="form-group mt-2">
                                            <label style="color: rgb(128, 128, 128); font-size:18px">Date Requested:</label>
                                            <span id="date_requested" style="border-color: rgb(166, 166, 166); font-size:18px"
                                ...
                                <div class="form-group px-0">
                                    ...
                                    <input id="priority" style="border-color: rgb(166, 166, 166)" type="text" class="form-control"
                                        name="priority" value="HIGH" readonly>
                                </div>

                                <div class="row card-body">
                                    <label style="color: rgb(128, 128, 128)">Description</label>
                                    <p id="description" class="card-text">I am writing to you to request for repair and maintenance of the
