    ...
    <div class="row justify-content-center">
        <div style="margin-top:8%;" class="col-md-12">
            ...
            <div class="card-group row d-flex align-items-center justify-content-center gap-3 mx-2">
                <div class="card mb-3 rounded col-12 col-md-4" style="height: 170px;border-style: none; box-shadow: 0px 4px 4px 0px #5B626D; background-image: linear-gradient(to bottom, #135083, #165a92, #1864a1, #1b6eb0, #1d78c0);">
                    <div class="card-body text-black">
                        <div class="svg-cont d-flex justify-content-md-end">
                            <select style="width: 35mm; height: 9mm" id="locs" class="form-select" @error('locs') is-invalid @enderror name="locs" autocomplete="locs"> </select> &nbsp;
                ...
                <div class="card  mb-3  mb-1 rounded col-12 col-md-4" style="height: 170px;border-style: none; box-shadow: 0px 4px 4px 0px #9399a1; background-image: linear-gradient(to bottom, #4d9fe3, #67aae4, #7db6e6, #93c1e7, #a9cce8);">
                    <div class="card-body text-black">
                        <div class="svg-cont d-flex justify-content-md-end">
                ...
                <div class="card mb-3 mb-1 rounded col-12 col-md-4" style="height: 170px;border-style: none; box-shadow: 0px 4px 4px 0px #5B626D; background-image: linear-gradient(to bottom, #135083, #165a92, #1864a1, #1b6eb0, #1d78c0);">
...
<div class="row p-3">
    <div class="col-md-5 ">
        ...
        <div class="card mb-3  mb-3 rounded p-2" style="box-shadow: 0px 4px 4px 0px #9399a1; ">
        <div class="d-flex justify-content-end" >
            <select id="yearSelect" style="width: fit-content;">
    ...
    <div class="col-md-7">
        <div class="container md-10 mb-5">
            <div id="calendar" style="box-shadow: 0px 4px 4px 0px #9399a1; "></div>
        </div>
