        ...
        <div class="row justify-content-center">
            <div style="margin-top:7%;" class="col-md-12">
                ...
                <div class="card-group row d-flex align-items-center justify-content-center gap-3 mx-2">
                    ...
                    <div class="card border-dark mb-3 shadow-sm p-3 mb-5 rounded col-12 col-md-4">
                        <div class="card-body text-black">
                            <div class="svg-cont d-flex justify-content-md-end">
                            ...
                            <h4 id="propertyCount" class="card-title">Properties: {{ $totalProperties }}</h4>
                    ...
                    <div class="card border-warning mb-3 shadow-sm p-3 mb-5 rounded col-12 col-md-4 mb-4">
                    ...
                    <div class="card border-success mb-3 shadow-sm p-3 mb-5 rounded col-12 col-md-4 mb-4">
                        <div class="card-body text-black">
                            <div class="svg-cont d-flex justify-content-md-end">
