...
<div class="container-fluid"> <div class="row justify-content-center"> <div style="margin-top:7%;" class="col-md-12">
    ...
    <div class="card-body text-black">
        ...
        name="locs" autocomplete="locs"> </select> &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
...
<div class="card-body text-black">
    <div class="svg-cont d-flex justify-content-md-end">
        <select style="width: 35mm; height: 9mm" id="prop_locs" class="form-select" @error('prop_locs') is-invalid
            @enderror name="prop_locs" autocomplete="prop_locs">
        </select>
        &nbsp;
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-houses"
            viewBox="0 0 16 16">
            <path
