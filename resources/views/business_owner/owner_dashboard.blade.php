    ...
    <div class="row justify-content-center">
        <div style="margin-top:7%;" class="col-md-12">
            ...
            <div class="card-group row d-flex align-items-center justify-content-center gap-3 mx-2">
                <div class="card border-primary mb-3 shadow-sm p-1 mb-3 rounded col-12 col-md-4" style="height: 170px;border-style: none;background-color:  #FFFFFF;">
                    <div class="card-body text-black">
                        <div class="svg-cont d-flex justify-content-md-end">
                            <select style="width: 35mm; height: 9mm" id="locs" class="form-select" @error('locs') is-invalid @enderror name="locs" autocomplete="locs"> </select> &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
        ...
        1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z" />
                ...
                <div class="card border-dark mb-3 shadow-sm p-2 mb-1 rounded col-12 col-md-4" style="height: 170px;border-style: none;background-color: #253031;">
                    <div class="card-body text-black">
                        <div class="svg-cont d-flex justify-content-md-end">
                            <select style="width: 35mm; height: 9mm" id="prop_locs" class="form-select" @error('prop_locs') is-invalid @enderror name="prop_locs" autocomplete="prop_locs">
                            </select>
                            &nbsp;
                        ...
                        <div class="row">
                            <div class="col-6">
                                <h6 id="availPropertyCount" class="card-title" style="color: #FFFFFF;">Available: {{ $availProperties }}</h6>
                            </div>
                            <div class="col-6">
                                <h6 id="occupiedPropertyCount" class="card-title" style="color: #FFFFFF;">Occupied: {{ $occupiedProperties }}
                                </h6>
                ...
                <div class="card border-warning mb-3 shadow-sm p-2 mb-1 rounded col-12 col-md-4" style="height: 170px;border-style: none;background-color: #FFFFFF;">
                ...
                <div class="card border-success mb-3 shadow-sm p-2 mb-1 rounded col-12 col-md-4 " style="height: 170px;border-style: none;background-color: #253031;">
                    <div class="card-body text-black">
                        <div class="svg-cont d-flex justify-content-md-end">
                            <select style="width: 35mm; height: 9mm" id="month_select" name="month_select" class="form-select form-select-sm">
