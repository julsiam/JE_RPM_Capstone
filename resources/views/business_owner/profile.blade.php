                    ...
                    <div class="card-body text-center">
                        <form method="POST" action="{{ route('edit_profile_pic') }}" enctype="multipart/form-data">
                            ...
                            <img id="profilePicturePreview"
                                ...
                                style="border: solid 5px #FFA500; width: 150px;">
                            @else
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#A9CCE8;">
                            <h5 class="modal-title" id="addAnnouncementModalLabel" style="color:#135083; font-weight: 700;">{{ __('Edit Profile') }}</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('edit_profile') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text col-md-4 text-md-end">{{ __('First Name') }}</span>
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text col-md-4 text-md-end">{{ __('Email') }}</span>
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text col-md-4 text-md-end">{{ __('Birthdate') }}</span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text col-md-4 text-md-end">{{ __('Phone Number') }}</span>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn"  style="background-color: #FFA500; color:#135083;">{{ __('Update') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
