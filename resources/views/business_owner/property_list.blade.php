                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #A9CCE8;">
                                <h3 class="modal-title" id="addAnnouncementModalLabel"
                                    style="letter-spacing: 2px; color: #003057; font-weight: 700;">
                                    {{ __('Edit Property') }}
                                </h3>
                                    ...
                                    <div class="mb-3">
                                        <div class="p-2">
                                            <input id="edit_property_id" required style="border-color: rgb(166, 166, 166)"
                                                type="hidden" class="form-control" name="edit_property_id"
                                                value="" readonly>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
