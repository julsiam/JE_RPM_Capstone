...
<div class="container" style="margin-top: 7%">
    ...
    <div class="container" style="margin-top: 10px">
        ...
        <div class="card mt-2 mb-3">
            <div class="row justify-content-center" style="margin-left: inherit; margin-right: inherit; background-color:#A9CCE8">
            ...
            <div class="p-2">
                ...
                <div class="d-flex justify-content-between" style="font-size: 110%">
                    <div class="col-form-label" style="color: #003057;font-weight: 700;">Total <span class=" p-1" style="background-color:#FFA500; border-radius: 10px;">Occupied</span>
                    ...
                    <tbody id="tenantListBody">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="text-black p-1" style="background-color:#A9CCE8; border-radius: 10px;">Available</span>
                                @else
                                {{ $property->status }}
                                @endif
                            </td>
                            ...
                            <td> <button class="btn btn-outline-primary  btn-sm propertyDetailsBtn" data-property-id='{{ $property->id }}' data-bs-toggle='modal' data-bs-target='#propertyModal'>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: #A9CCE8;">
                            <h3 class="modal-title" id="addAnnouncementModalLabel" style="letter-spacing: 2px; color: #003057; font-weight: 700;">
                                {{ __('Edit Property') }}
                            </h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="edit_location" name="edit_location" type="text" style="background-color: #d3d3d3;" class="form-control @error('edit_location') is-invalid @enderror" value="{{ old('edit_location') }}" readonly>
                                                @error('edit_location')
                                                ...
                                                <input id="edit_room_unit" name="edit_room_unit" type="text" style="background-color: #d3d3d3;" class="form-control @error('edit_room_unit') is-invalid @enderror" value="{{ old('edit_room_unit') }}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="edit_occupant" name="edit_occupant" type="text" style="background-color: #d3d3d3;" class="form-control @error('edit_occupant') is-invalid @enderror" value="" required autofocus readonly>
                                                @error('edit_occupant')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                ...
                                                <input id="edit_status" name="edit_status" type="text" style="background-color: #d3d3d3;" class="form-control @error('edit_status') is-invalid @enderror" value="{{ old('edit_status') }}" required autofocus readonly>
                                                @error('edit_status')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
