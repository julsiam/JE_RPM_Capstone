...
">
                ...
                <div class="col-md-6 text-end" style="padding-top: 13px;">
                    ...
                    {{-- SHEET --}}
                    <a href="{{route('properties_export')}}" class="btn btn-outline-success me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-xls" viewBox="0 0 16 16">
                    ...
                    {{-- REFRESH --}}
                    <a href="" class="btn btn-outline-secondary me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
                ...
                <table id="propertyTable" class="table table-hover">
                    ...
                    <tbody id="tenantListBody">
                        ...
                        <tr>
                            ...
                            <td> <button class="btn btn-primary btn-sm propertyDetailsBtn" data-property-id='{{ $property->id }}' data-bs-toggle='modal' data-bs-target='#propertyModal'>
