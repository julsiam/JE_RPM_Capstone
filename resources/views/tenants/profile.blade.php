        ...
        <div class="container py-5 mt-5">
            ...
            <div class="row">
                        ...
                        <div class="card-body text-center">
                            <form method="POST" action="{{ route('edit_profile_pic') }}" enctype="multipart/form-data">
                                ...
                                <img id="profilePicturePreview"
                                    src="{{ Storage::disk('s3')->url($profilePicture->file_path) }}" alt="Profile Picture"
                                    class="rounded-circle img-fluid" style="border: solid 5px #FFA500; width: 150px;">

                                <h5 class="my-3" style="color:#135083; font-weight: 700;">{{ Auth::user()->first_name }}
                                ...
                                {{-- <div class="d-flex justify-content-center mb-2">
                                    <label for="profilePictureInput" class="btn btn-outline-warning ms-1"
                                        style="color:#135083;">
                ...
                <div class="col-lg-8">
                    <div class="card mb-4" style="background-color: #A9CCE8;">
                        <div class="mx-3 p-2">
                            <button type="button" class="btn profile_edit_btn mb-3"
                                style="float:right; background-color: #FFA500; color:#135083; "
                        ...
                        <div class="card-body" style="color:#135083;">
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-9">
                                    <p id="first_name" class="text-muted mb-0" style="font-weight: 700;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0" style="font-weight: 700;">{{ Auth::user()->phone_number }}
                                    </p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0" style="font-weight: 700;">
                                        {{ Auth::user()->birthdate->format('F d, Y') }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                        ...
                        <div class="modal-content">
                            <div class="modal-header" style="background-color:#A9CCE8;">
                                <h5 class="modal-title" id="addAnnouncementModalLabel"
                                    style="color:#135083; font-weight: 700;">{{ __('Edit Profile') }}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form method="POST" action="{{ route('edit-tenant-profile') }}">
                                    @csrf
                                    <div class="mb-3">
                                        <div class="p-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span
                                                        class="input-group-text col-md-4 text-md-end">{{ __('Email') }}</span>
                                                ...
                                                <div class="input-group mb-3">
                                                    <span
                                                        class="input-group-text col-md-4 text-md-end">{{ __('Birthdate') }}</span>
                                                ...
                                                <div class="input-group mb-3">
                                                    <span
                                                        class="input-group-text col-md-4 text-md-end">{{ __('Address') }}</span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span
                                                        class="input-group-text col-md-4 text-md-end">{{ __('Last Name') }}</span>
                                                ...
                                                <div class="input-group mb-3">
                                                    <span
                                                        class="input-group-text col-md-4 text-md-end">{{ __('Age') }}</span>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn"
                                            style="background-color: #FFA500; color:#135083;">{{ __('Update') }}</button>
                                    </div>
                            </div>
                            </form>
                        </div>
